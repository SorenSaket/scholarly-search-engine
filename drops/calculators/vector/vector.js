...
function addVector(){
    ...
    var txt1 = '<tr id="vector' + count +'" style="background-color:' + colors[count] +';"><td><input id="x' + count + '" class="form-control w-100" placeholder="x"></td><td><input id="y'+ count +'" style="display:inline" class="form-control w-100" placeholder="y" ></td><td><button type="button" class="close" aria-label="Close" onclick="removeVector('+ count +')"><span aria-hidden="true">&times;</span></button></td></tr>';
